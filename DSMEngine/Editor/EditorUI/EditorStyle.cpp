...
namespace DSM {
    ...
    inline void StyleClassic()
    {
        ...
        EditorStyle::sm_ColorInfo      = {235.0f / 255.0f, 235.0f / 255.0f, 235.0f / 255.0f, 1.0f};
        EditorStyle::sm_ColorWarning   = {255.0f / 255.0f, 149.0f / 255.0f, 49.0f / 255.0f, 1.0f};
        EditorStyle::sm_ColorError     = {255.0f / 255.0f, 58.0f / 255.0f, 58.0f / 255.0f, 1.0f};
    }
    ...
    inline void SetupImGuiColors()
    {
        ...
        ImVec4 color_accent_2                            = Lerp(h_color_1,h_color_2, 0.2f);
        ImVec4 color_accent_3                            = Lerp(h_color_1,h_color_2, 0.3f);
    ...
    void EditorStyle::OnGUIEnabled()
    {
        ...
        if(ImGui::BeginChild("Selected Color Child", childSize, ImGuiChildFlags_Borders | ImGuiChildFlags_AutoResizeY)){
            ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, {8,8});

            if(ImGui::ColorEdit4("Background 1",&bg_color_1.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Background 2",&bg_color_2.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Highlight 1",&h_color_1.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Highlight 2",&h_color_2.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Accent 1",&color_accent_1.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Accent 2",&color_accent_2.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Info",&EditorStyle::sm_ColorInfo.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Warning",&EditorStyle::sm_ColorWarning.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
            if(ImGui::ColorEdit4("Error",&EditorStyle::sm_ColorError.x)){
                m_Changes = true;
                SetupImGuiColors();
            }
